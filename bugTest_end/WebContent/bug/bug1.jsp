...
.btn btn-success{text-align:center;}
.fb-share-button{text-align:center;}
...
<% 	String contentPage = request.getParameter("CONTENTPAGE");
	if(contentPage == null){
		contentPage = "bug1.jsp";
	}
%>

	<div>
	<section id="areaMain">
		<img src="../img/test/1문제.png">
		<form method='post' action='main.jsp?CONTENTPAGE=../bug/bugresult1.jsp'>
		<input type="radio" name="chk1" value='1'>1. 나무들이 너무 울창해서 햇살조차 안 드는 숲과 같은 정원<br>
		<input type="radio" name="chk1" value='2'>2. 나무들은 울창하지만 햇살이 조금 스며드는 숲 같은 정원<br>
		<input type="radio" name="chk1" value='3'>3. 커다란 나무 한 그루가 심어져 있는 정원<br>
		<input type="radio" name="chk1" value='4'>4. 아직 나무들이 크게 자라 있지 않은 정원<br>
  ...
  <div class="fb-share-button" 
         ...
         <h4> 댓글 </h4>
          ...
          <% } else {%>
       				  <textarea class="form-control" id="comment" name = "detail" rows="3"  required ></textarea>
          				...
          				<input type ="hidden" id = "title_no" name = "title_no" value='1'>
        			</div>
	...
	<%
		...
		if((comment.getTitle_no()).equals("1")){
