...
<% 	String contentPage = request.getParameter("CONTENTPAGE");
	if(contentPage == null){
		contentPage = "bug3.jsp";
	}
%>

	<div>
	<section id="areaMain">
		<form method='post' action='main.jsp?CONTENTPAGE=../bug/bugresult3.jsp'>
		<img src="../img/test/3-1목록.png">
		<input type="text" name="animal" placeholder="입력해 주세요">
		<img src="../img/test/3-2목록.png">
		<input type="text" name="bug" placeholder="숫자만 입력">
		<img src="../img/test/3-3목록.png">
		<input type="text" name="sho" placeholder="숫자만 입력">
		<img src="../img/test/3-4목록.png">
		<input type="text" name="cups" placeholder="숫자만 입력">
		<img src="../img/test/3-5목록.png">
		<input type="text" name="whitem" placeholder="입력해 주세요"><br>
