...
<% 	String contentPage = request.getParameter("CONTENTPAGE");
	if(contentPage == null){
		contentPage = "bug6.jsp";
	}
%>
	
	<div>
	<section id="areaMain">
		<img src="../img/test/6문제.png">
		<form method='post' action='main.jsp?CONTENTPAGE=../bug/bugresult6.jsp'>
		<input type="radio" name="chk6" value='1'>1. 수명이 끝나 소멸했다<br>
		<input type="radio" name="chk6" value='2'>2. 구름에 감추어진 것뿐이다<br>
		<input type="radio" name="chk6" value='3'>3. 다른 별과 충동하여 부서져 버렸다<br>
		<input type="radio" name="chk6" value='4'>4. 그 별은 환상이었다<br>
