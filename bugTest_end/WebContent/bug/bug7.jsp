...
<% 	String contentPage = request.getParameter("CONTENTPAGE");
	if(contentPage == null){
		contentPage = "bug7.jsp";
	}
%>
	
	<div>
	<section id="areaMain">
		<img src="../img/test/7문제.png">
		<form method='post' action='main.jsp?CONTENTPAGE=../bug/bugresult7.jsp'>
		<input type="radio" name="chk7" value='1'>1. 과일<br>
		<input type="radio" name="chk7" value='2'>2. 떡<br>
		<input type="radio" name="chk7" value='3'>3. 수정구슬<br>
		<input type="radio" name="chk7" value='4'>4. 현찰<br>
		<input type="radio" name="chk7" value='5'>5. 반지<br>
  ...
  <div class="fb-share-button" 
         ...
         <h4> 댓글 </h4>
          ...
          <% } else {%>
       				  <textarea class="form-control" id="comment" name = "detail" rows="3"  required ></textarea>
          				...
          				<input type ="hidden" id = "title_no" name = "title_no" value='7'>
        			</div>
	...
	<%
		...
		if((comment.getTitle_no()).equals("7")){
