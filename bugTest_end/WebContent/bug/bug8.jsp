...
%>
	...
	<div>
	<section id="areaMain">
		<img src="../img/test/8문제.png">
		<form method='post' action='main.jsp?CONTENTPAGE=../bug/bugresult8.jsp'>
		<input type="radio" name="chk8" value='1'>1. 컵의 손잡이만 잡는다<br>
		<input type="radio" name="chk8" value='2'>2. 컵의 손잡이에 손을 끼고 컵의 전체를 감싸며 잡는다<br>
		<input type="radio" name="chk8" value='3'>3. 컵의 손잡이를 잡고 새끼손가락으로 컵의 옆부분을 잡는다<br>
		<input type="radio" name="chk8" value='4'>4. 컵의 손잡이를 잡고 새끼손가락으로 컵의 밑바닥을 받친다<br>
  ...
  <div class="fb-share-button" 
         ...
         <h4> 댓글 </h4>
          ...
          <% } else {%>
       				  <textarea class="form-control" id="comment" name = "detail" rows="3"  required ></textarea>
          				...
          				<input type ="hidden" id = "title_no" name = "title_no" value='8'>
        			</div>
	...
	<%
		...
		if((comment.getTitle_no()).equals("8")){
