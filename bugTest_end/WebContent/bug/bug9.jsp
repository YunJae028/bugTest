...
%>
	...
	<div>
	<section id="areaMain">
		<img src="../img/test/9문제.png">
		<form method='post' action='main.jsp?CONTENTPAGE=../bug/bugresult9.jsp'>
		<input type="radio" name="chk9" value='1'>1. "이런 곳에 저런 게 있다니 뭔지 몰라도 방해가 되는군"<br>
		<input type="radio" name="chk9" value='2'>2. "아니, 이런 곳에 이런 게 있다니? 옆으로 치워야겠군"<br>
		<input type="radio" name="chk9" value='3'>3. "저게 뭘까? 네가 가서 봐"<br>
		<input type="radio" name="chk9" value='4'>4. "수상하니까 가까이 가지 말아야겠다. 다른 길로 돌아가야겠군"<br>
  ...
  <div class="fb-share-button" 
         ...
         <h4> 댓글 </h4>
          ...
          <% } else {%>
       				  <textarea class="form-control" id="comment" name = "detail" rows="3"  required ></textarea>
          				...
          				<input type ="hidden" id = "title_no" name = "title_no" value='9'>
        			</div>
	...
	<%
		...
		if((comment.getTitle_no()).equals("9")){
