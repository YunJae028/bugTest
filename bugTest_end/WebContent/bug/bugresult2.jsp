...
%>
	...
	<section id="areaMain">
		...
		<% String chk2 = request.getParameter("chk2");
			String chkk = chk2;
			if(chk2.equals("1")){%>
				<img src="../img/test/2-1.png">
			<%}
			if(chk2.equals("2")){%>
			<img src="../img/test/2-2.png">
			<%}
			if(chk2.equals("3")){%>
			<img src="../img/test/2-3.png">
			<%}
			if(chk2.equals("4")){%>
			<img src="../img/test/2-4.png">
			<%}
			if(chk2.equals("5")){%>
			<img src="../img/test/2-5.png">
			<%}
			%>
			<form method='post' action='main.jsp?CONTENTPAGE=../bug/bug2.jsp'>
