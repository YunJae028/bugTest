...
%>
	...
	<div>
	<section id="areaMain">
		<img src="../img/test/4.png"><br>
		
		<%
		String imsinum = getrndnum(9);
		String name = request.getParameter("name");

			out.print("<br>"+name+"의 가격표 <br> 금액 ");
			
			out.print(imsinum+"원 <br><br><br>");
			%>
			
			<form method='post' action='main.jsp?CONTENTPAGE=../bug/bug4.jsp'>
  ...
  <div class="fb-share-button" 
         ...
         <h4> 댓글 </h4>
          ...
          <% } else {%>
       				  <textarea class="form-control" id="comment" name = "detail" rows="3"  required ></textarea>
          				...
          				<input type ="hidden" id = "title_no" name = "title_no" value='4'>
        			</div>
	...
	<%
		...
		if((comment.getTitle_no()).equals("4")){
