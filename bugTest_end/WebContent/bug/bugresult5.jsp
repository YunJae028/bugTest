...
%>
	...
	<section id="areaMain">
		<% String chk3 = request.getParameter("chk3");
			String chkk = chk3;
			if(chk3.equals("1")){%>
				<img src="../img/test/3-1.png">
			<%}
			if(chk3.equals("2")){%>
			<img src="../img/test/3-2.png">
			<%}
			if(chk3.equals("3")){%>
			<img src="../img/test/3-3.png">
			<%}
			if(chk3.equals("4")){%>
			<img src="../img/test/3-4.png">
			<%}
			%>
			<form method='post' action='main.jsp?CONTENTPAGE=../bug/bug5.jsp'>
