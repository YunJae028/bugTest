...
%>
	...
	<div>
	<section id="areaMain">
		<% String chk1 = request.getParameter("chk7");
			String chkk = chk1;
			if(chk1.equals("1")){%>
				<img src="../img/test/7-1.png">
			<%}
			if(chk1.equals("2")){%>
			<img src="../img/test/7-2.png">
			<%}
			if(chk1.equals("3")){%>
			<img src="../img/test/7-3.png">
			<%}
			if(chk1.equals("4")){%>
			<img src="../img/test/7-4.png">
			<%}
			if(chk1.equals("5")){%>
			<img src="../img/test/7-5.png"><% }%>
			<form method='post' action='main.jsp?CONTENTPAGE=../bug/bug7.jsp'>
