...
%>
	...
	<div>
	<section id="areaMain">
		<% String chk1 = request.getParameter("chk8");
			String chkk = chk1;
			if(chk1.equals("1")){%>
				<img src="../img/test/8-1.png">
			<%}
			if(chk1.equals("2")){%>
			<img src="../img/test/8-2.png">
			<%}
			if(chk1.equals("3")){%>
			<img src="../img/test/8-3.png">
			<%}
			if(chk1.equals("4")){%>
			<img src="../img/test/8-4.png">
			<%}
			%>
			<form method='post' action='main.jsp?CONTENTPAGE=../bug/bug8.jsp'>
