...
%>
	...
	<div>
	<section id="areaMain">
		<% String chk1 = request.getParameter("chk9");
			String chkk = chk1;
			if(chk1.equals("1")){%>
				<img src="../img/test/9-1.png">
			<%}
			if(chk1.equals("2")){%>
			<img src="../img/test/9-2.png">
			<%}
			if(chk1.equals("3")){%>
			<img src="../img/test/9-3.png">
			<%}
			if(chk1.equals("4")){%>
			<img src="../img/test/9-4.png">
			<%}
			%>
			<form method='post' action='main.jsp?CONTENTPAGE=../bug/bug9.jsp'>
